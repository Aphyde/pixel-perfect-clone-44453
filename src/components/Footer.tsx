...
const Footer = () => (
  <footer className="bg-foreground text-primary-foreground p-6 pt-10 md:p-12 md:pt-16">
    <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 md:gap-10">
      <div className="md:col-span-1">
        <Image
          ...
          quality={65}
        />
        <p className="font-body text-xs md:text-sm leading-relaxed text-primary-foreground/60 mb-4">
          Ihr Spezialist für Aluminium-Terrassendächer, Markisen und Carports in
          Ulm. Seit über 10 Jahren Qualität aus der Region.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-3 md:gap-4">
        ...
        <Link
          href="/standorte"
          className="font-body text-xs md:text-sm text-primary-fixed-dim hover:text-primary-foreground transition-colors"
        >
          Alle Standorte →
        </Link>
      </div>
    ...
    <div className="max-w-7xl mx-auto mt-10 md:mt-16 pt-6 md:pt-8 border-t border-primary-foreground/10 flex flex-col items-center gap-2">
      <p className="font-body text-[11px] md:text-sm text-primary-foreground/60 text-center">
        © 2025 Brait Überdachungen – eine Marke von{" "}
        <a
          href="https://bau-braitinger.de/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary-foreground/80 hover:text-primary transition-colors underline underline-offset-2"
        >
          SMT Konzepte GmbH
        </a>
      </p>
      <p className="font-body text-[10px] md:text-xs text-primary-foreground/55 text-center">
        Website &amp; Marketing von{" "}
        <a
          href="https://rossigroup.de"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary-foreground/70 hover:text-primary transition-colors underline underline-offset-2"
        >
          rossigroup.de
        </a>
      </p>
