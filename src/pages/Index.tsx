  ...
  <Layout>
    ...
    <section className="relative h-[972px] flex items-center pt-20 overflow-hidden bg-foreground">
      ...
      <div className="container mx-auto px-8 relative z-10">
        <div className="max-w-4xl">
          <motion.span
            ...
            className="inline-block bg-primary text-primary-foreground px-4 py-1 text-xs font-bold tracking-[0.3em] uppercase mb-6"
          >
            Ulm &amp; Umgebung
          </motion.span>
          <motion.h1
            ...
            className="text-6xl md:text-8xl font-bold text-primary-foreground leading-[0.9] tracking-tighter mb-8"
          >
            Exklusive <br />
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-primary-foreground/70 max-w-xl mb-12 font-light leading-relaxed"
          >
      ...
      <motion.div
        ...
        className="absolute bottom-0 right-12 w-0.5 bg-primary"
      />
    </section>
    ...
    <section className="py-32 bg-surface">
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-end mb-24">
          ...
          <FadeIn delay={0.2} direction="left" className="md:col-span-5 border-l-2 border-primary pl-8 pb-2">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-1" staggerDelay={0.15}>
          {[
            ...
            <StaggerItem key={item.title}>
              <div className="bg-surface-container-low p-12 hover:bg-surface-container-high transition-colors h-full">
                {item.icon}
    ...
    <section className="relative bg-surface-container-low overflow-hidden">
      <div className="container mx-auto px-0 md:px-8 py-32">
        <div className="flex flex-col md:flex-row gap-0">
          <FadeIn direction="left" className="w-full md:w-1/2 bg-foreground aspect-square md:aspect-auto">
          ...
          <FadeIn direction="right" delay={0.2} className="w-full md:w-1/2 bg-card p-12 md:p-24 flex flex-col justify-center">
            ...
            <StaggerContainer className="grid grid-cols-2 gap-8 mb-12" staggerDelay={0.2} delay={0.3}>
              <StaggerItem>
    ...
    <section className="py-32 bg-surface">
      <div className="container mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:h-[800px]">
          <ScaleIn className="md:col-span-8 md:row-span-2 relative group overflow-hidden">
          ...
          <ScaleIn delay={0.15} className="md:col-span-4 relative group overflow-hidden">
          ...
          <ScaleIn delay={0.3} className="md:col-span-4 relative group overflow-hidden">
    ...
    <section className="py-20 bg-surface-container">
      <div className="container mx-auto px-8">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <FadeIn direction="right" delay={0.2} className="w-full md:w-2/3 h-[400px]">
