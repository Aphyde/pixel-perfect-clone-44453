          ...
          <div className="md:col-span-11 grid grid-cols-1 md:grid-cols-2 gap-24">
            ...
            <FadeIn delay={0.3} className="relative">
              ...
              <motion.div
                ...
                className="absolute -top-8 -left-8 p-8 bg-surface border border-outline-variant/10 shadow-xl hidden md:block"
              >
      ...
      <section className="px-8 max-w-7xl mx-auto mt-32">
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-0" staggerDelay={0.15}>
          <StaggerItem direction="left">
            <div className="bg-primary text-primary-foreground p-12 flex flex-col justify-between h-full">
          ...
          <StaggerItem direction="right">
            <div className="bg-surface-container-highest p-12 flex flex-col justify-center h-full">
