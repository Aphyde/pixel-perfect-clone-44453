...
import { Phone, Mail, Clock, ShieldCheck, MapPin, Upload, ArrowRight, ArrowLeft, X, Check, Send, Image as ImageIcon, Briefcase, Sparkles, PackageOpen, Wrench } from "lucide-react";
...
const Kontakt = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const messageWithProjekt = [
        form.produktTyp ? `Projekt: ${form.produktTyp}` : "",
        form.message,
      ]
        .filter(Boolean)
        .join("\n\n");
  ...
  return (
    <Layout>
      <div className="pt-24 md:pt-32">
          ...
          >
            ...
            <div className="bg-surface-container-low p-12 flex flex-col justify-end relative overflow-hidden">
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-2">Beratung vor Ort</h3>
                <p className="text-secondary">Wir kommen zu Ihnen –<br />kostenlos in Ulm und Umgebung.</p>
                ...
                >
                  ...
                  {step === 3 && (
                    <div className="space-y-5">
                      ...
                      >
                        <ImageIcon className="w-10 h-10 text-outline-variant mb-3" />
              ...
              <StaggerContainer className="space-y-8" staggerDelay={0.15}>
                <StaggerItem>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="text-[10px] uppercase tracking-widest text-outline font-bold">Telefon</p>
                      <a href="tel:+491735303581" className="text-lg font-bold hover:text-primary transition-colors">0173 530 3581</a>
                    </div>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@brait-ueberdachung.de" className="text-lg font-bold break-all hover:text-primary transition-colors">info@brait-ueberdachung.de</a>
                    </div>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="text-[10px] uppercase tracking-widest text-outline font-bold">Erreichbarkeit</p>
            ...
            <FadeIn delay={0.4}>
              <div className="bg-surface-container-high p-8">
                ...
                <div className="mt-8 overflow-hidden">
                  <img
                    src={ulmLuftbild}
                    alt="Luftbild von Ulm mit Ulmer Münster – unser Einsatzgebiet"
        ...
        <section
          id="demo-koffer"
          className="relative bg-foreground text-primary-foreground overflow-hidden mt-16 md:mt-24 scroll-mt-24 border-b border-primary"
        >
          <div className="max-w-7xl mx-auto px-5 md:px-8 py-16 md:py-24">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
              <FadeIn direction="left" className="lg:col-span-6 order-2 lg:order-1">
                <div className="inline-flex items-center gap-2 mb-4 md:mb-6">
                  <span className="w-10 h-[2px] bg-primary" />
                  <span className="font-headline uppercase tracking-[0.25em] text-xs md:text-sm text-primary font-bold">Kostenlos &amp; unverbindlich</span>
                </div>
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tighter leading-[0.95] mb-5 md:mb-7">
                  Anfassen statt rätseln. <br />
                  <span className="text-primary">Unser Demo-Koffer kommt zu Ihnen.</span>
                </h2>
                <p className="text-base md:text-lg text-primary-foreground/75 leading-relaxed mb-8 md:mb-10 max-w-xl">
                  Original-Profile, echtes Glas, RAL-Farbmuster und Beschläge — alles was Ihre künftige Terrassenüberdachung ausmacht, in einem Koffer. Wir bauen vor Ihren Augen ein Mini-Modell zusammen und beantworten alle Fragen direkt am Objekt.
                </p>

                <div className="grid grid-cols-2 gap-3 md:gap-4 mb-8 md:mb-10">
                  <div className="border-l-2 border-primary pl-4">
                    <PackageOpen className="w-5 h-5 text-primary mb-2" />
                    <p className="font-bold text-sm md:text-base mb-1">Echte Materialien</p>
                    <p className="text-xs md:text-sm text-primary-foreground/65 leading-snug">Aluminium-Profile, VSG-Glas, Polycarbonat &amp; LED-Muster.</p>
                  </div>
                  <div className="border-l-2 border-primary pl-4">
                    <Sparkles className="w-5 h-5 text-primary mb-2" />
                    <p className="font-bold text-sm md:text-base mb-1">RAL-Farbpalette</p>
                    <p className="text-xs md:text-sm text-primary-foreground/65 leading-snug">Anthrazit, Schwarz, Verkehrs- und Cremeweiß zum Vergleich.</p>
                  </div>
                  <div className="border-l-2 border-primary pl-4">
                    <Wrench className="w-5 h-5 text-primary mb-2" />
                    <p className="font-bold text-sm md:text-base mb-1">Live-Aufbau</p>
                    <p className="text-xs md:text-sm text-primary-foreground/65 leading-snug">Wir stecken die Profile vor Ort zu einem Mini-Rahmen zusammen.</p>
                  </div>
                  <div className="border-l-2 border-primary pl-4">
                    <MapPin className="w-5 h-5 text-primary mb-2" />
                    <p className="font-bold text-sm md:text-base mb-1">Ulm &amp; Umgebung</p>
                    <p className="text-xs md:text-sm text-primary-foreground/65 leading-snug">Wir kommen kostenlos zu Ihnen — keine Kaufverpflichtung.</p>
                  </div>
                </div>
                ...
                <p className="mt-5 md:mt-6 text-xs md:text-sm text-primary-foreground/55 flex items-center gap-2">
                  <Check className="w-4 h-4 text-primary" /> 100 % kostenlos &middot; Mo - Fr 09:00 - 18:00 &middot; Sa 10:00 - 14:00
                </p>
              </FadeIn>

              <FadeIn direction="right" delay={0.1} className="lg:col-span-6 order-1 lg:order-2">
                <div className="relative">
                  ...
                  <img
                    src={demoKoffer}
                    alt="Demo-Koffer von Brait Überdachungen mit Aluminium-Profilen, Glas-Mustern und RAL-Farbkarten"
