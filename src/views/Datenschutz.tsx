    ...
    <div className="pt-24 md:pt-32 pb-16 md:pb-24">
      ...
      <section className="px-5 md:px-8 max-w-4xl mx-auto">
        ...
        <FadeIn className="mt-16 md:mt-24 pt-8 border-t border-outline-variant/20">
          <p className="text-xs text-secondary">Stand: März 2026 · Bei Fragen zum Datenschutz wenden Sie sich an info@brait-ueberdachung.de</p>
        </FadeIn>
      </section>
    </div>
  </Layout>
